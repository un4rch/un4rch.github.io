  ...
  if (!project) {
    return (
      <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6">
        ...
        <Link href="/" className="flex items-center space-x-2 text-[#FF0040] hover:text-white transition-colors">
  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <div className="container mx-auto px-6 py-8">
        <Link
          href="/"
          className="inline-flex items-center space-x-2 text-[#FF0040] hover:text-white transition-colors mb-12"
        >
          <ArrowLeft className="h-5 w-5" />
          <span>Back to home</span>
        </Link>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="about-box">
              <h3 className="text-white font-semibold mb-1">Year</h3>
              <p className="text-gray-400">{project.year}</p>
            </div>
            <div className="about-box">
              <h3 className="text-white font-semibold mb-1">Role</h3>
              <p className="text-gray-400">Lead UX/UI Designer</p>
            </div>
          </div>
          ...
          <div className="prose prose-lg prose-invert max-w-none">
            {project.fullDescription.split("\n\n").map((paragraph: string, index: number) => {
              if (paragraph.trim().startsWith("•")) {
                ...
                return (
                  <ul key={index} className="list-disc pl-5 text-gray-300 mb-6">
